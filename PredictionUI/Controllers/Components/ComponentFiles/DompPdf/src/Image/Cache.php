...
class Cache
{
     ...
     * @param string $protocol  Client protocol if none specified in $url
     * @param string $host      Client host if none specified in $url
     * @param string $base_path Client path if none specified in $url
