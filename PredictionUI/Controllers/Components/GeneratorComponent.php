...
class GeneratorComponent extends BerkaPhpComponent
{
    ...
    function __construct()
    {
        ...
        $this->controller_path = "Controllers/".\BerkaPhp\Helper\Html::getCurrentPrefix(false)."/{name}Controller.php";
        $this->model_path = "Models/{name}Model.php";
        $this->view_path = "Views/".\BerkaPhp\Helper\Html::getCurrentPrefix(false)."/{controller}/{view}.php";
        $this->prefix = \BerkaPhp\Helper\Html::getCurrentPrefix(false);
    ...
    private static function  getColumnInfo($type){
        ...
        } elseif (strpos("blob", $type ) !== false ||  preg_match('/blob/',$type)){
            $info['type'] = 'file';
    ...
    private function getControllerClass() {
        ...
        $class_controller = str_replace('{prefix}', strtolower(\BerkaPhp\Helper\Html::getCurrentPrefix()), $class_controller);
