...
<head>
    ...
    <link rel="stylesheet" href="/Views/Admin/Layout/css/vendor.css">
    <!-- Theme initialization -->
    <link rel="stylesheet" id="theme-style" href="/Views/Admin/Layout/css/app.css">
</head>
<body>
        ...
        <aside class="sidebar">
            <div class="sidebar-container">
                <div class="sidebar-header">
                    <div class="brand">
                        <div class="logo">
                            <img width="187px" class="imgLogo" src="/Views/Client/Assets/logo.png" alt="">
                        </div>
                    </div>
                </div>
                <nav class="menu">
...
<script src="/Views/Admin/Layout/js/vendor.js"></script>
