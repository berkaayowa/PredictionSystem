...
function indexMode(chart, e, options) {
	...
	// Client axis for index mode is 'x' to match old behaviour
...
// Client passive to true as expected by Chrome for 'touchstart' and 'touchend' events.
...
module.exports = function(Chart) {
	...
	// Client config for a category scale
	var defaultConfig = {
		position: 'bottom'
	};
