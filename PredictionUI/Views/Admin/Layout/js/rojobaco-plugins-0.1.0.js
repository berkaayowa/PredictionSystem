(function() {
    ...
    SearchSelect = (function() {
        ...
        function SearchSelect(Element, Options) {
            ...
            this.Spinner = $('<img>').attr('src', 'https://fiberlean1.sharepoint.com/_layouts/15/images/gears_anv4.gif?rev=44').attr('id', 'searchselectloading').css('height', '20px').addClass('pull-right');
            ...
            if (typeIsFunction(self.Source)) {
                ...
                $.ajax(requestUrl, {
                    ...
                    complete: function() {
                        ...
                        if (self.Options.onLoaded != null) {
                            self.Options.onLoaded(self.Element);
                        }
                    }
                });
            }
        ...
        initLoadData = function(search, self) {
            var found, i, item, len, listItem, mappedItem, onLiClick, ref;
            found = 0;
            ...
            for (i = 0, len = ref.length; i < len; i++) {
                ...
                listItem = $('<li>').attr('data-search-value', mappedItem.value).css('text-transform', 'capitalize').addClass(found === 0 ? 'first-matched' : void 0).html(mappedItem.label).on('click', onLiClick).appendTo(self.SearchList);
