...
<div class="">
    <div class="panel panel-default">
        <form method="POST" action="<?= BerkaPhp\Helper\Html::action('/categories/add')?>" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <textarea data-editor="true" rows="10" class="form-control " name="CatDescription" id="CatDescription" placeholder="cat description"></textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control " name="CatIcon" id="CatIcon" placeholder="cat icon">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <input type="number" class="form-control " name="CatOrder" id="CatOrder" placeholder="cat order">
            </div>
        </div>
