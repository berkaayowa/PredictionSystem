...
<div class="">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12">
            <input type="text" class="form-control " name="ProductFullName" id="ProductFullName" value="<?=$data["ProductFullName"]?>" placeholder="product full name">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12">
            <input data-select-text="<?= Rep::GetData('brands', 'BrandID',$data["RefBrandID"])['BrandName']?>" type="number" data-select="<?=$data["RefBrandID"]?>" data-type ="Brands" data-value="BrandID" data-text="BrandName"  class="form-control " name="RefBrandID" id="RefBrandID">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12">
            <input data-select-text="<?= Rep::GetData('product_categories', 'CatID',$data["RefCategoryID"])['CatName']?>" type="number" data-select="<?=$data["RefCategoryID"]?>" data-type ="Categories" data-value="CatID" data-text="CatName" class="form-control " name="RefCategoryID" id="RefCategoryID">
        </div>
    </div>
...
<!--            --><?//=$data["IsOnPromotion"] == "1" ? "checked=true" : ""?>
        
<!--    <div class="form-group row">-->
<!--        <label class="control-label brk-php-label col-sm-12" for="RefPromotionID">ref promotion i d</label>-->
<!--        <div class="col-sm-12">-->
<!--            <input type="number" class="form-control " name="RefPromotionID" id="RefPromotionID" value="" placeholder="ref promotion i d">-->
<!--        </div>-->
<!--    </div>-->
...
<!--                <input type="text" class="form-control " data-date data-format="YYYY-MM-DD HH:mm" name="AddedDateTime" id="AddedDateTime" value="" placeholder="added date time">-->
