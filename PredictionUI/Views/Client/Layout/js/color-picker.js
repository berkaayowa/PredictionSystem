    ...
    var options = {
        ...
        buildCallback: function($elm) { // called the first time colorPicker gets triggered
            ...
            $elm.append( // render extra sliders and patch
                '<div class="cp-rgb-r hide"><div class="cp-rgb-r-cursor"></div></div>' +
                '<div class="cp-rgb-g hide"><div class="cp-rgb-g-cursor"></div></div>' +
                '<div class="cp-rgb-b hide"><div class="cp-rgb-b-cursor"></div></div>' +
                '<div class="cp-patch hide"><div></div></div><div class="cp-disp hide"></div>');
