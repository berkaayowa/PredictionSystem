                            ...
                            <div class="col-sm-12">
                                <table class="table table-striped predictionTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="txt-capitalized text-right tSubItem">
                                            <div id="progress" class="right">
                                                <span id="percent" class="home">
                                                    <?=number_format((float) $prediction->HomeTeam->LastGamesPerecentage, 2, '.', '')?>%
                                                </span>
                                                <div id="bar" class="barHome" style="width: <?=number_format((float) $prediction->HomeTeam->LastGamesPerecentage, 2, '.', '')?>%"></div>
                                            </div>
                                        </td>
                                        <td class="txt-capitalized text-left tSubItem">
                                            <div id="progress" class="left">
                                                <span id="percent" class="away">
                                                    <?=number_format((float) $prediction->AwayTeam->LastGamesPerecentage, 2, '.', '')?>%
                                                </span>
                                                <div id="bar" class="awayHome" style="width: <?=number_format((float) $prediction->AwayTeam->LastGamesPerecentage, 2, '.', '')?>%"></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="txt-capitalized text-right">
                                            <div id="progress" class="right">
                                                ...
                                                <div id="bar" class="barHome"  style="width: <?=number_format((float) $prediction->HomeTeam->AwayOrHomePerecentage, 2, '.', '')?>%"></div>
                                            </div>
                                        </td>
                                        <td class="txt-capitalized text-left tSubItem">
                                            <div id="progress">
                                                ...
                                                <div id="bar" style="width: <?=number_format((float) $prediction->AwayTeam->AwayOrHomePerecentage, 2, '.', '')?>%"></div>
                                            </div>
                                        </td>
                                    </tr>
